    ...
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.println(lebelMap.size());
            	...
            	File outputfileDir = new File("rtsne_out_lebeled.csv");
		...
		Writer out = new BufferedWriter(new OutputStreamWriter(
            ...
            in.close();
             ...
             File rtsnefileDir = new File("rtsne_out.csv");
             mapLoc = 1;
		...
		out.flush();
            ...
            Logger.getLogger(LabelRtsneMatrix.class.getName()).log(Level.SEVERE, null, ex);
